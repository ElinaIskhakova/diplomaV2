...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -498, 956, 1293))
        ...
        self.ShifrUBT = QtWidgets.QComboBox(self.groupBox)
        self.ShifrUBT.setObjectName("ShifrUBT")
        self.ShifrUBT.addItem("")
        ...
        self.ShifrTrubi = QtWidgets.QComboBox(self.groupBox)
        self.ShifrTrubi.setObjectName("ShifrTrubi")
        self.ShifrTrubi.addItem("")
        ...
        self.TipNasosa.addItem("")
        self.formLayout.setWidget(41, QtWidgets.QFormLayout.LabelRole, self.TipNasosa)
        self.label_22 = QtWidgets.QLabel(self.groupBox)
        self.label_22.setObjectName("label_22")
        self.formLayout.setWidget(42, QtWidgets.QFormLayout.LabelRole, self.label_22)
        self.VPZ = QtWidgets.QLineEdit(self.groupBox)
        self.VPZ.setObjectName("VPZ")
        self.formLayout.setWidget(43, QtWidgets.QFormLayout.LabelRole, self.VPZ)
        self.label_27 = QtWidgets.QLabel(self.groupBox)
        self.label_27.setEnabled(True)
        self.label_27.setWordWrap(False)
        self.label_27.setObjectName("label_27")
        self.formLayout.setWidget(44, QtWidgets.QFormLayout.LabelRole, self.label_27)
        self.NapryagSdvigaTo = QtWidgets.QLineEdit(self.groupBox)
        self.NapryagSdvigaTo.setObjectName("NapryagSdvigaTo")
        self.formLayout.setWidget(45, QtWidgets.QFormLayout.LabelRole, self.NapryagSdvigaTo)
        self.label_28 = QtWidgets.QLabel(self.groupBox)
        self.label_28.setObjectName("label_28")
        self.formLayout.setWidget(46, QtWidgets.QFormLayout.LabelRole, self.label_28)
        self.StructVyazkostN = QtWidgets.QLineEdit(self.groupBox)
        self.StructVyazkostN.setObjectName("StructVyazkostN")
        self.formLayout.setWidget(47, QtWidgets.QFormLayout.LabelRole, self.StructVyazkostN)
        self.label_29 = QtWidgets.QLabel(self.groupBox)
        self.label_29.setObjectName("label_29")
        self.formLayout.setWidget(48, QtWidgets.QFormLayout.LabelRole, self.label_29)
        self.VidOperacii = QtWidgets.QComboBox(self.groupBox)
        self.VidOperacii.setObjectName("VidOperacii")
        self.VidOperacii.addItem("")
        self.VidOperacii.addItem("")
        self.formLayout.setWidget(49, QtWidgets.QFormLayout.LabelRole, self.VidOperacii)
        self.label_30 = QtWidgets.QLabel(self.groupBox)
        self.label_30.setWordWrap(True)
        self.label_30.setObjectName("label_30")
        self.formLayout.setWidget(50, QtWidgets.QFormLayout.SpanningRole, self.label_30)
        self.DlinaSkvazhinkZaboy = QtWidgets.QLineEdit(self.groupBox)
        self.DlinaSkvazhinkZaboy.setObjectName("DlinaSkvazhinkZaboy")
        self.formLayout.setWidget(51, QtWidgets.QFormLayout.LabelRole, self.DlinaSkvazhinkZaboy)
        self.TrubiOpisanie = QtWidgets.QPushButton(self.groupBox)
        self.TrubiOpisanie.setObjectName("TrubiOpisanie")
        self.formLayout.setWidget(52, QtWidgets.QFormLayout.LabelRole, self.TrubiOpisanie)
        self.btnPlotnost = QtWidgets.QPushButton(self.groupBox)
        self.btnPlotnost.setObjectName("btnPlotnost")
        self.formLayout.setWidget(53, QtWidgets.QFormLayout.LabelRole, self.btnPlotnost)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ShifrUBT.setItemText(0, _translate("MainWindow", "УБТС"))
        ...
        self.ShifrTrubi.setItemText(0, _translate("MainWindow", "ЛБТС3"))
        ...
        self.TrubiOpisanie.setText(_translate("MainWindow", "Характеристика труб"))
        self.btnPlotnost.setText(_translate("MainWindow", "Выбор плотности и предварительной подачи насосов"))
